...
$q = "select top (5) MaXe, Avatar, Xe.Gia, TenLoaiXe, PhanTramGiam, MaHangSX from Xe left join GiaKhuyenMai as km on Xe.MaGiaKM = km.MaGiaKM, LoaiXe as lx where Xe.MaLoaiXe = lx.MaLoaiXe and Xe.MaGiaKM is not null and TinhTrang is null";
