...
public class Xe_lienquan_khuyenmai {
    String img;
    String tenxe;
    String giaxe;
    String diachi;
    ...
    public Xe_lienquan_khuyenmai(String img, String tenxe, String giaxe, String diachi, String ma_xe, String ma_sx,String phantramgiam) {
        this.img = img;
        this.tenxe = tenxe;
        this.giaxe = giaxe;
        this.diachi = diachi;
